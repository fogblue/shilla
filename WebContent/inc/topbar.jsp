...
<header id="site-header">
	<div class="tcontainer clearfix">
		<div class="menu1 list-inline downrow dropdown">
			<button class="btn btn-topbar1 dropdown-toggle" data-toggle="dropdown">호텔찾기 <span class="caret"></span></button>
		...
		<div class="box1">
			<a href="/iot5/index.jsp"><span class="pull-left logo">My Site</span></a>
		</div>
		...
		<div>
			<ul class="menu3 list-inline pull-right downrow">
				<li class="menu-item"><a href="/iot5/info/hotelinfo.jsp"><button class="btn btn-topbar">호텔신라
						소개</button></a></li>
