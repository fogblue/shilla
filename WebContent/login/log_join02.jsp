		...
		<div class="log_body ">
			...
			<form class="form-horizontal" name="join_form" id="join_form">
				<div class="basic_data">
					<h6 class="basic_data_title">기본 정보 입력 (*표시 필수입력사항)</h6>
					...
					<div class="form-group">
						...
						<div class="col-md-3 col-md-10">
							<input type="text" name="user_name" id="user_name_eng"
								class="form-control" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<input type="tel" name="tel" id="tel_home" class="form-control" />
						</div>
					</div>
					<div class="form-group">
				...
				$("#join_form")
					.submit(
						function(e) {
							...
							if (!regex.compare_to('#user_pw',
									'#user_pw_re', '비밀번호 확인이 잘못되었습니다.')) {
								return false;
							}

									/** 이름 검사 */
							if (!regex
									.value('#user_name', '이름을 입력하세요.')) {
								return false;
							}
							if (!regex.kor('#user_name',
									'이름은 한글만 입력 가능합니다.')) {
								return false;
							}
