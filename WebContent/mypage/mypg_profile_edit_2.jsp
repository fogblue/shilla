		...
		<div class="sidebar">
			<div class="sidebar-cont">
				...
				<div class="mypg-sidebar-menu">
					...
					<a>개인정보</a>
					<a href="/iot5/mypage/mypg_profile_edit.jsp" class="mypg-sidebar-open">프로필 수정</a>
					<a href="/iot5/mypage/mypg_password_edit.jsp">비밀번호 변경<img src="/iot5/img/sidebar_arr.gif" class="sidebar-arrow"></a>
