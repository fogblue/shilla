...
<header id="site-header">
	<div class="tcontainer clearfix">
		...
		<div class="menu1 list-inline downrow">
			<a
				href="${pageContext.request.contextPath}/reservation/reservation.do"
				class="btn btn-topbar1">예약</a>
		</div>
		<div class="box1">

			<a href="${pageContext.request.contextPath}/"><span
				class="pull-left logo">My Site</span></a>
		</div>
		<c:choose>
		...
		<div>
			<ul class="menu3 list-inline pull-right downrow">
				...
				<li class="menu-item"><a
					href="${pageContext.request.contextPath}/info/hotelinfo.do"><button
							class="btn btn-topbar">호텔신라 소개</button></a></li>
				<li class="menu-item"><a
					href="${pageContext.request.contextPath}/info/contactinfo.do"><button
							class="btn btn-topbar">고객문의</button></a></li>
				<li class="menu-item"><a
					href="${pageContext.request.contextPath}/member/login_test.do"
					class="btn btn-topbar">신라리워즈</a></li>
			</ul>
		</div>
	</div>
</header>
