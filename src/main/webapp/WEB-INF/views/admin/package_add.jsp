		...
		<div class="if-contents">
			...
			<form class="form-horizontal" name="package_add" id="package_add" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/package_add_ok.do">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<label><textarea name='package_content'></textarea></label>
					</div>
				</div>
				<div class="form-group">
					<label for='package_img' class="col-md-2"> <span class='identify'>*</span>패키지 사진</label>
					<div class="col-md-10">
						<input type="file" id="package_img" multiple />
					</div>
				</div>
				<div class="form-group">
