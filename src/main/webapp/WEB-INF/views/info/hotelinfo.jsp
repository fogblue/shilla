...
<body>
	...
	<div class="container main">
		...
		<div class="if-contents">
			...
			<div class="imgbox">
				<img src="${pageContext.request.contextPath}/assets/img/brandMainImg.jpg" alt="exmimg" />
			</div>
			<br />
			<div class="con1">
				<h3>Samsung Group Affiliate</h3>
				<p>호텔신라는 수많은 국빈의 방문과 국제행사를 치러내며‘삼성 그룹을 대표하는 얼굴’, ‘한국을 대표하는 호텔’로서
					자부심과 책임감을 가지고 우리나라 서비스 산업의 견인차 역할을 해오고 있습니다.</p>
				...
				<table>
					<tr class="missionbox">
						<td class="artibox">
							<h4>신라인으로서 미션</h4>
							<hr class="artiboxhr" /> 우리는 Premium Lifestyle을<br> 선도하는
							신라인으로서<br> 각각의 분야에서<br> 최고의 전문가로 성장한다.
						</td>
					</tr>
					<tr class="missionbox">
						<td class="artibox">
							<h4>고객에 대한 미션</h4>
							<hr class="artiboxhr" /> 우리는 더 많은 고객이<br> 다양한 생활영역에서<br>
							신라만의 품격과<br> 자부심을 경험케 한다.
						</td>
					</tr>
					<tr class="missionbox">
						<td class="artibox">
							<h4>사회에 대한 미션</h4>
							<hr class="artiboxhr" /> 우리는 지속적인 혁신과<br> 성장을 통해 인류가<br>
							더 나은 삶을 누릴 수 있도록<br> 기여한다.
						</td>
					</tr>
				</table>
				<br />
