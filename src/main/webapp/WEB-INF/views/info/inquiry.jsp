...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/assets/css/info.css" />
</head>
<body>
	...
	<div class="container main">
		...
		<div class="sidebar">
			...
			<!-- 메뉴 들어갈 곳 -->
			<a href="${pageContext.request.contextPath}/info/contactinfo.do" class="imenu">연락처</a> <a
				href="${pageContext.request.contextPath}/info/inquiry.do" class="imenu">문의하기</a>
		</div>
		<div class="if-contents">
			...
			<table class="table">
				...
				<tr>
					...
					<td><form action="upload_ok.do" method="post"
