	...
	<div class="container main">
		<div class="sidebar">
			...
			<a href="${pageContext.request.contextPath}/info/hotelinfo.do" class="imenu">개요</a> <a
				href="${pageContext.request.contextPath}/info/seoulshilla.do" class="imenu info-open">서울신라호텔 <img src="${pageContext.request.contextPath}/assets/img/sidebar_arr.gif" class="sidebar-arrow"></a> <a
