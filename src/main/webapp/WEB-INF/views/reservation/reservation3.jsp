					...
					<div class="rsv_customerinfobox">
						<div class="rsv_customerinfo col-sm-6">
							...
							*성명(한글) <select name="jender" disabled>
							...
							</select><input type="text" disabled value="이름" name="name" />
							<br/><br/>
							*성명(영문) <input type="text" disabled value="LASTNAME" name="name" />
							<input type="text" disabled value="FIRSTNAME" name="name" />
							<br/><br/>
							*지역(여권기준) <select name="jender" disabled>
								<option selected="selected">South Korea</option>
							</select>
							<br/><br/>
							*이메일 <input type="text" disabled value="E-mail" name="email" />
							<br/><br/>
						...
						<div class="rsv_cardinfo col-sm-6">
							<p>카드 정보 입력</p>
							*카드종류
							<select class="uiform" id="guestCardTypCd" name="guestCardTypCd" title="카드사 선택">
							...
							<br/><br/>
							*카드번호 <input type="text" class="cardno" name="cardno" />-<input type="text" class="cardno" name="cardno" />-<input type="text" class="cardno" name="cardno" />
							<br/><br/>
							*만기일 <select name="month">
							...
							<br/><br/><br/>
							<p>※신용카드 정보는 고객님의 투숙에 의한 개런티 외에는 어떤 목적으로도 사용되지 않습니다.<br/>온라인 예약 시 직접 결제가 이루어지지 않으며,
최종 결제는 체크아웃 시 프런트 데스크에서 해주시기 바랍니다.</p>
						</div>
					</div>
					<br/><br/>
					<div class="rsv_infor">
...
<!-- ==예약신청 모달== ==예약신청 모달== ==예약신청 모달== ==예약신청 모달== ==예약신청 모달== ==예약신청 모달== ==예약신청 모달== ==예약신청 모달== ==예약신청 모달== -->
						<div class="rsv_packagewarn clearfix">
								<!-- 링크로 모달 열기 -->
								<a href="#" class="btn btn-warning rsv_rsvapplibtn" data-toggle="modal"
									data-target="#myModal2"> 예약신청 </a>
							</div> <!-- Modal -->
