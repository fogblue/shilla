						...
						<div class="rsv_text2">
							...
							<div class="rsv_useguidebox">
								...
								<a href="#" class="btn btn-warning" data-toggle="modal"
									data-target="#myModal">혜택 및 이용안내 + </a>
							</div>
							...
							<div class="rsv_collapse">
								...
								<div class='rsv_collapse-item'>
									...
									<div id="rsv_content1" class="rsv_content">
										...
										<div class="rsv_content1-1-1">Double</div>
										<div class="rsv_content1-1-2">
											290,000 원~ <input type="radio" name="subject" />
										</div>
										<br /> <br />
										<hr />
										<br />
						...
						<div class="rev_bedselect" id="rsv_roomarc2">
							<div class="rsv_collapse">
								...
								<div class='rsv_collapse-item'>
									...
									<div class='rsv_collapse-title'>
										[Executive] Executive Business Deluxe<button class="btn btn-sm rsv_selectbtn" onclick="location.href='${pageContext.request.contextPath}/reservation/reservation2.do'">선택</button>
									</div>
									<!-- 게시글 내용영역 -->
									<div id="rsv_content1" class="rsv_content">
										...
										<div class="rsv_content1-1-2">
											520,000 원~ <input type="radio" name="subject" />
										</div>
										<br /> <br />
										<hr />
										<br />
...
<!-- ----------------------------------------------------------------------------------------------------- -->
						<div class="rsv_text2">
							...
							<div class="rsv_useguidebox">
								<!-- 링크로 모달 열기 -->
								<a href="#" class="btn btn-warning" data-toggle="modal"
									data-target="#myModal">객실 자세히 보기 + </a>
							</div>
					...
					<div class="rsv_roomlistbox">
						...
						<div class="rsv_text2">
							...
							<div class="rsv_useguidebox">
								<!-- 링크로 모달 열기 -->
								<a href="#" class="btn btn-warning" data-toggle="modal"
									data-target="#myModal2">객실 자세히 보기 + </a>
							</div>
							<!-- Modal -->
							<div class="modal fade" id="myModal2">
								<div class="modal-dialog modal-md">
