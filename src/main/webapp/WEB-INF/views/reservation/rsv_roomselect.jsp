	...
	<div class="container2">
		<div>
			...
			<ul class="nav nav-tabs" id="mytab">
				<li class="active"><a href="#page1" data-toggle="tab">전체(6)</a></li>
				<li><a href="#page2" data-toggle="tab">패키지(2)</a></li>
				<li><a href="#page3" data-toggle="tab">객실(4)</a></li>
			</ul>
			<!-- 탭 페이지 구성 -->
...
<!-- 리스트 1개 끝 ============================================================================================================================================================================== -->
				...
				<div role="tabpanel" class="tab-pane fade" id="page2">
					...
					<div class="rsv_roomlistbox">
						...
						<div class="rsv_text2">
							<ul>
								<li class="rsv_text2_1">350,000~</li>
								<li class="rsv_text2_2">원/1박</li>
							</ul>
							<p class="rsv_desc">혜택 및 이용안내</p>
						</div>
					</div>
				</div>
